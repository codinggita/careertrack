...
import { LayoutDashboard, Briefcase, GraduationCap, Trophy, Plus } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-blue-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 p-6 sm:p-10">
            ...
            <motion.button
                ...
                className="fixed bottom-8 right-8 z-40 bg-indigo-600 dark:bg-indigo-500 text-white p-5 rounded-full shadow-2xl shadow-indigo-500/30 dark:shadow-none hover:bg-indigo-700 dark:hover:bg-indigo-400 transition-all flex items-center gap-3 border border-indigo-400/20 group"
            >
                <div className="bg-white/20 p-1 rounded-lg">
                    <Plus className="w-6 h-6 text-white" />
                </div>
                <span className="font-black text-sm pr-1 hidden group-hover:block transition-all duration-300">Quick Add Application</span>
            </motion.button>
